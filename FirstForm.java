...
public class FirstForm extends javax.swing.JFrame {
    ...
    public void loadBST(){
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader(Main.FilePath + "\\src\\wordList.txt"));
            ...
            while(line != null){
                ...
                //inserting ayat numbers in linkedlist of word Node
                while(ayats != null){
            ...
            System.out.println("File Not Found Exception (wordlist.txt)");
        }
    }
    ...
    private void SearchFieldKeyReleased() {//GEN-FIRST:event_SearchFieldKeyReleased
